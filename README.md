...
## Screenshot
![Screenshot](./assets/imgs/screenshot-000.jpg)
...
- Display Manager: `sddm` - [**blank_sddm_theme**](https://github.com/ForeverWeLearn/blank_sddm_theme)
...
- Video Player: **vlc** `vlc` `vlc-pause-click-plugin`
